    ...
    public class LanguageManager
    {
        ...
        public LanguageManager()
        {
            ...
            _translations = new Dictionary<string, Dictionary<Language, string>>
            {
                ...
                ["settings_priority_ext"] = new() { [Language.English] = "Priority extensions (V3)", [Language.French] = "Extensions prioritaires (V3)" },
                ["settings_priority_ext_desc"] = new() { [Language.English] = "Comma-separated; these files are saved before others across all jobs (empty = no priority)", [Language.French] = "Séparées par des virgules ; ces fichiers sont sauvegardés avant les autres sur tous les travaux (vide = pas de priorité)" },
